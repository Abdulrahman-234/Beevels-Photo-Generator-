...
class PhotoGallery{
  constructor(){
    this.API_KEY = '563492ad6f917000010000019914c1a04330495cbcde1950ce4ddb0f';
    this.galleryDIv = document.querySelector('.gallery');
    this.searchForm = document.querySelector('.input-container form');
  ...
  // <img class="photographer-img" src="${photo.photographer_url}"></img>
